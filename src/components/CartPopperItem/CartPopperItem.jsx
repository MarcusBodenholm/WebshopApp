        ...
        <>
            ...
            <Stack direction="column" sx={{width:"100%", maxHeight:"480px", justifyContent:"space-between", marginTop:"5px"}}>
                ...
                <Stack direction="column" className="cart-summary" spacing={1}>
                    ...
                    <Button variant="outlined" onClick={handleGotoCheckoutClick} disabled={authUser === null || cart.totalItems === 0} className="go-to-checkout-button">Gå till kassan</Button>
                </Stack>
            </Stack>
        </>
    )
